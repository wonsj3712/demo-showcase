...
// 회사별 STORM 에이전트 (NH농협생명)
const MODE_CONFIG: Record<AgentMode, { agentId: string; proxyPath: string; role: string }> = {
  copilot: {
    agentId: (import.meta.env.VITE_STORM_AGENT_COPILOT as string) || '7475035395623297024',
    proxyPath: '/storm-api/copilot',
    role: 'nh_copilot',
  },
  qa: {
    agentId: (import.meta.env.VITE_STORM_AGENT_QA as string) || '7475035451983646720',
